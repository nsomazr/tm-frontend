...
export default function ReportPreviewContent({
  ...
  return (
    <article className="card overflow-hidden">
      <header className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 pb-5 border-b app-divider">
      ...
      {hasFullAccess ? (
        <div className="pt-6 space-y-6">
          {summaryText && (
            <p className="text-sm sm:text-base map-text-secondary leading-relaxed whitespace-pre-wrap">{summaryText}</p>
          )}
          {findings.length > 0 && (
            <section>
              <h2 className="text-sm font-semibold map-text mb-3">{r.keyFindingsTitle}</h2>
        ...
        <div className="pt-6">
          <div className="relative">
            ...
            <div
              className="report-preview-fade absolute inset-x-0 top-[38%] bottom-0 z-10"
              aria-hidden
            />
          </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          {summaryText && (
            <div className="mt-3 relative">
              <p className="text-sm map-text-secondary leading-relaxed line-clamp-3">{summaryText}</p>
